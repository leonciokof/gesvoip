...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Factura.id_factura'
        # db.alter_column('factura', 'id_factura',
        # self.gf('django.db.models.fields.AutoField')(primary_key=True))
        db.execute(
            "SELECT SETVAL('factura_id_factura_seq', (SELECT MAX(id_factura) FROM factura))")
        db.execute(
            "ALTER TABLE factura ALTER COLUMN id_factura SET DEFAULT nextval('factura_id_factura_seq'::regclass)")
    ...
    def backwards(self, orm):
        ...
        db.execute(
            "ALTER TABLE factura ALTER COLUMN id_factura DROP DEFAULT")
        db.execute("DROP SEQUENCE factura_id_factura_seq")
