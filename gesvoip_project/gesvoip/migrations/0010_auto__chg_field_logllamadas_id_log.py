...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LogLlamadas.id_log'
        # db.alter_column('log_llamadas', 'id_log',
        # self.gf('django.db.models.fields.AutoField')(primary_key=True))
        db.execute(
            "SELECT SETVAL('log_llamadas_id_log_seq', (SELECT MAX(id_log) FROM log_llamadas))")
        db.execute(
            "ALTER TABLE log_llamadas ALTER COLUMN id_log SET DEFAULT nextval('log_llamadas_id_log_seq'::regclass)")
    ...
    def backwards(self, orm):
        ...
        db.execute(
            "ALTER TABLE log_llamadas ALTER COLUMN id_log DROP DEFAULT")
        db.execute("DROP SEQUENCE log_llamadas_id_log_seq")
