...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DetFactura.id_detalle'
        # db.alter_column('det_factura', 'id_detalle',
        # self.gf('django.db.models.fields.AutoField')(primary_key=True))
        db.execute(
            "SELECT SETVAL('det_factura_id_detalle_seq', (SELECT MAX(id_detalle) FROM det_factura))")
        db.execute(
            "ALTER TABLE det_factura ALTER COLUMN id_detalle SET DEFAULT nextval('det_factura_id_detalle_seq'::regclass)")
    ...
    def backwards(self, orm):
        ...
        db.execute(
            "ALTER TABLE det_factura ALTER COLUMN id_detalle DROP DEFAULT")
        db.execute("DROP SEQUENCE det_factura_id_detalle_seq")
