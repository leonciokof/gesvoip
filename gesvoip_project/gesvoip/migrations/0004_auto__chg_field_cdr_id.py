...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cdr.id'
        # db.alter_column('cdr', 'id',
        # self.gf('django.db.models.fields.AutoField')(primary_key=True))
        db.execute(
            "SELECT SETVAL('cdr_id_seq', (SELECT MAX(id) FROM cdr))")
        db.execute(
            "ALTER TABLE cdr ALTER COLUMN id SET DEFAULT nextval('cdr_id_seq'::regclass)")
    ...
    def backwards(self, orm):
        ...
        db.execute(
            "ALTER TABLE cdr ALTER COLUMN id DROP DEFAULT")
        db.execute("DROP SEQUENCE cdr_id_seq")
