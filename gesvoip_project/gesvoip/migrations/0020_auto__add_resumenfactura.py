...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResumenFactura'
        db.create_table('resumen_factura', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('factura', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gesvoip.Factura'])),
            ('fecha_inicio', self.gf('django.db.models.fields.DateField')()),
            ('fecha_fin', self.gf('django.db.models.fields.DateField')()),
            ('duracion_normal', self.gf('django.db.models.fields.IntegerField')()),
            ('duracion_reducido', self.gf('django.db.models.fields.IntegerField')()),
            ('duracion_nocturno', self.gf('django.db.models.fields.IntegerField')()),
            ('tarifa_normal', self.gf('django.db.models.fields.FloatField')()),
            ('tarifa_reducido', self.gf('django.db.models.fields.FloatField')()),
            ('tarifa_nocturno', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal(u'gesvoip', ['ResumenFactura'])


    def backwards(self, orm):
        # Deleting model 'ResumenFactura'
        db.delete_table('resumen_factura')
