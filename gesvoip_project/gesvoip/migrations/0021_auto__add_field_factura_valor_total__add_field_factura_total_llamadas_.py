...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Factura.valor_total'
        db.add_column('factura', 'valor_total',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Factura.total_llamadas'
        db.add_column('factura', 'total_llamadas',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Factura.total_segundos'
        db.add_column('factura', 'total_segundos',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Factura.valor_total'
        db.delete_column('factura', 'valor_total')

        # Deleting field 'Factura.total_llamadas'
        db.delete_column('factura', 'total_llamadas')

        # Deleting field 'Factura.total_segundos'
        db.delete_column('factura', 'total_segundos')
    ...
    models = {
        ...
        u'gesvoip.factura': {
            ...
            'total_llamadas': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'total_segundos': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'usuario': ('django.db.models.fields.related.ForeignKey', [], {'default': '38', 'to': u"orm['gesvoip.Usuarios']", 'db_column': "'usuario'"}),
            ...
            'valor_total': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'year': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '4', 'blank': 'True'})
        },
        u'gesvoip.feriado': {
        ...
        u'gesvoip.resumenfactura': {
            'Meta': {'object_name': 'ResumenFactura', 'db_table': "'resumen_factura'"},
            'duracion_nocturno': ('django.db.models.fields.IntegerField', [], {}),
            'duracion_normal': ('django.db.models.fields.IntegerField', [], {}),
            'duracion_reducido': ('django.db.models.fields.IntegerField', [], {}),
            'factura': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['gesvoip.Factura']"}),
            'fecha_fin': ('django.db.models.fields.DateField', [], {}),
            'fecha_inicio': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tarifa_nocturno': ('django.db.models.fields.FloatField', [], {}),
            'tarifa_normal': ('django.db.models.fields.FloatField', [], {}),
            'tarifa_reducido': ('django.db.models.fields.FloatField', [], {}),
