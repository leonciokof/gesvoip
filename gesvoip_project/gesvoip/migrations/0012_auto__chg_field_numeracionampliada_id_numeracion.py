...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NumeracionAmpliada.id_numeracion'
        # db.alter_column('numeracion_ampliada', 'id_numeracion',
        # self.gf('django.db.models.fields.AutoField')(primary_key=True))
        db.execute("CREATE SEQUENCE numeracion_ampliada_id_usuario_seq")
        db.execute(
            "SELECT SETVAL('numeracion_ampliada_id_numeracion_seq', (SELECT MAX(id_numeracion) FROM numeracion_ampliada))")
        db.execute(
            "ALTER TABLE numeracion_ampliada ALTER COLUMN id_numeracion SET DEFAULT nextval('numeracion_ampliada_id_numeracion_seq'::regclass)")
    ...
    def backwards(self, orm):
        ...
        db.execute(
            "ALTER TABLE numeracion_ampliada ALTER COLUMN id_numeracion DROP DEFAULT")
        db.execute("DROP SEQUENCE numeracion_ampliada_id_numeracion_seq")
