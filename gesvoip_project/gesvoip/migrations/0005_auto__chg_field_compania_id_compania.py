...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Compania.id_compania'
        # db.alter_column('compania', 'id_compania',
        # self.gf('django.db.models.fields.AutoField')(primary_key=True))
        # db.execute("CREATE SEQUENCE compania_id_compania_seq")
        db.execute(
            "SELECT SETVAL('compania_id_compania_seq', (SELECT MAX(id_compania) FROM compania))")
        db.execute(
            "ALTER TABLE compania ALTER COLUMN id_compania SET DEFAULT nextval('compania_id_compania_seq'::regclass)")
    ...
    def backwards(self, orm):
        ...
        db.execute(
            "ALTER TABLE compania ALTER COLUMN id_compania DROP DEFAULT")
        db.execute("DROP SEQUENCE compania_id_compania_seq")
