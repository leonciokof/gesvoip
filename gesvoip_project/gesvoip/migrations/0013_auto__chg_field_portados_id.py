...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Portados.id'
        # db.alter_column('portados', 'id',
        # self.gf('django.db.models.fields.AutoField')(primary_key=True))
        db.execute(
            "SELECT SETVAL('portados_id_seq', (SELECT MAX(id) FROM portados))")
        db.execute(
            "ALTER TABLE portados ALTER COLUMN id SET DEFAULT nextval('portados_id_seq'::regclass)")
    ...
    def backwards(self, orm):
        ...
        db.execute(
            "ALTER TABLE portados ALTER COLUMN id DROP DEFAULT")
        db.execute("DROP SEQUENCE portados_id_seq")
