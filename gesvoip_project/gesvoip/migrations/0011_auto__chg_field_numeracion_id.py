...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Numeracion.id'
        # db.alter_column('numeracion', 'id',
        # self.gf('django.db.models.fields.AutoField')(primary_key=True))
        db.execute(
            "SELECT SETVAL('numeracion_id_seq', (SELECT MAX(id) FROM numeracion))")
        db.execute(
            "ALTER TABLE numeracion ALTER COLUMN id SET DEFAULT nextval('numeracion_id_seq'::regclass)")
    ...
    def backwards(self, orm):
        ...
        db.execute(
            "ALTER TABLE numeracion ALTER COLUMN id DROP DEFAULT")
        db.execute("DROP SEQUENCE numeracion_id_seq")
