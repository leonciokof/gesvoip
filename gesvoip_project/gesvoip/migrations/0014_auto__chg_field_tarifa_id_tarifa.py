...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tarifa.id_tarifa'
        # db.alter_column('tarifa', 'id_tarifa',
        # self.gf('django.db.models.fields.AutoField')(primary_key=True))
        db.execute(
            "SELECT SETVAL('tarifa_id_tarifa_seq', (SELECT MAX(id_tarifa) FROM tarifa))")
        db.execute(
            "ALTER TABLE tarifa ALTER COLUMN id_tarifa SET DEFAULT nextval('tarifa_id_tarifa_seq'::regclass)")
    ...
    def backwards(self, orm):
        ...
        db.execute(
            "ALTER TABLE tarifa ALTER COLUMN id_tarifa DROP DEFAULT")
        db.execute("DROP SEQUENCE tarifa_id_tarifa_seq")
