...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Feriado.id_feriado'
        # db.alter_column('feriado', 'id_feriado',
        # self.gf('django.db.models.fields.AutoField')(primary_key=True))
        db.execute(
            "SELECT SETVAL('feriado_id_feriado_seq', (SELECT MAX(id_feriado) FROM feriado))")
        db.execute(
            "ALTER TABLE feriado ALTER COLUMN id_feriado SET DEFAULT nextval('feriado_id_feriado_seq'::regclass)")
    ...
    def backwards(self, orm):
        ...
        db.execute(
            "ALTER TABLE feriado ALTER COLUMN id_feriado DROP DEFAULT")
        db.execute("DROP SEQUENCE feriado_id_feriado_seq")
