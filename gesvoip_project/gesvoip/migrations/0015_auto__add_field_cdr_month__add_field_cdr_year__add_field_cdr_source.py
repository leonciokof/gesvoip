...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cdr.month'
        db.add_column('cdr', 'month',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True),
                      keep_default=False)

        # Adding field 'Cdr.year'
        db.add_column('cdr', 'year',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4, blank=True),
                      keep_default=False)

        # Adding field 'Cdr.source'
        db.add_column('cdr', 'source',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cdr.month'
        db.delete_column('cdr', 'month')

        # Deleting field 'Cdr.year'
        db.delete_column('cdr', 'year')

        # Deleting field 'Cdr.source'
        db.delete_column('cdr', 'source')
