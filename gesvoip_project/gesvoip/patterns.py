...
pattern_not_56446 = compile('^(?!56446)')
...
national = compile('^56')
international = compile('^(?!56)')
voip = compile('^(564469|44690|02344690)')
normal = compile('^(?!(564469|44690|02344690))')
