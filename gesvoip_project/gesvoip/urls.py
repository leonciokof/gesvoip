...
urlpatterns = patterns(
    ...
    url(r'^pnmtc_list/$', 'pnmtc_list', name='pnmtc_list'),
    url(r'^pnmtc_create/$', 'pnmtc_create', name='pnmtc_create'),
    url(r'^pnmtc_update/(?P<pk>\w+)/$', 'pnmtc_update', name='pnmtc_update'),
    url(r'^pnmtc_range/$', 'pnmtc_range', name='pnmtc_range'),
